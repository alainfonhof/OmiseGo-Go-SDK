...
type EwalletAdminAPI interface {
	...
	UserGetWalletsById(reqBody IdParam) (*WalletList, error)
	UserGetWalletsByProviderUserId(reqBody ProviderUserIdParam) (*WalletList, error)
	UserGetTransactionsById(reqBody IdParam) (*TransactionList, error)
	UserGetTransactionsByProviderUserId(reqBody ProviderUserIdParam) (*TransactionList, error)
